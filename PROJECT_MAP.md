...
- **M4.4:** Integrate real Socket.io events for Game State (Turn management, Scoring, Word Selection, synchronization). *(In Progress)*
  ...
  - [ ] **بناء واجهة اللعبة الموحدة (`IGameModule`):** فصل منطق الرسم والتخمين وتوجيه الأحداث الخاصة به.
  - [ ] **نظام الـ Batching وتخفيف الحمل على الـ Socket:** تجميع أحداث الرسم وإرسالها بحزم منتظمة (مثلاً كل 50ms) لكفاءة الأداء.
